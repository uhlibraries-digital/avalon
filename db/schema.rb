...
ActiveRecord::Schema.define(version: 2022_09_09_210351) do
  ...
  create_table "encode_queues", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "title"
    t.string "master_file_id"
